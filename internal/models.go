...
func klingModels() []modelInfo {
	...
	return []modelInfo{
		...
		{ID: "kling-v3", Object: "model", Created: created, OwnedBy: "kling-web", Capabilities: []string{"text_to_video", "image_to_video", "first_last_frame_video", "native_audio"}, Endpoint: "/v1/videos/generations", WebTaskTypes: []string{"m2v_omni_video"}, ProviderVersion: "3.0-omni", SupportStatus: "verified", Notes: "Kling video 3.0 Omni text-to-video was verified on SH01. This is not an image-generation model."},
		{ID: "kling-video-3.0", Object: "model", Created: created, OwnedBy: "kling-web", Capabilities: []string{"text_to_video", "image_to_video", "first_last_frame_video", "native_audio"}, Endpoint: "/v1/videos/generations", WebTaskTypes: []string{"m2v_omni_video"}, ProviderVersion: "3.0-omni", SupportStatus: "verified", Notes: "Alias for kling-v3."},
